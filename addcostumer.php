...
$data = "INSERT INTO Customer (customer_first_name, customer_last_name, customer_city_address, customer_street_address, customer_email, customer_due_amount,customer_payment_date) VALUES ( '$firstname', '$lastname', '$city', '$street', '$email', '$dueamount', '$paymentdate')";
