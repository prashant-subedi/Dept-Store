...
<body>
	<div class="w3-container">
		...
		<div class="w3-center">
			...
			Update Vacation For an Employee
		</span>
		</div>
		<div class="w3-section">
				<a class="w3-text-teal" href="/dept_store/vacations.php">Back</a>
		...
		<div class="w3-responsive">
			<table class="w3-table-all"> <!-- Make the table bordered!!! -->
				...
				<tr>
					...
					<td><input class="w3-input w3-border-0" type="text" name="datestart" placeholder="Start Date"></td>
					<td><input class="w3-input w3-border-0" type="text" name="dateend" placeholder="End Date"></td>
				</tr>
...
if($employeeid != ""){
$data = "UPDATE Vacation SET 
(employee_id, date_start,date_end) VALUES ( '$employeeid', '$datestart', '$dateend')";
$data = "UPDATE Vacation SET
